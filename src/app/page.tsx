  ...
  try {
    ...
    return (
      <div className="page-transition" style={{ padding: "3rem" }}>
        <div className="page-header">
          <h1 className="page-title">Unable to load the demo</h1>
          <p style={{ color: "var(--text-secondary)" }}>
            Something went wrong while loading the dashboard.
          </p>
          <p style={{ color: "var(--text-secondary)", marginTop: "1rem" }}>
            In some cases, this means the deployment is missing <code>DATABASE_URL</code>, <code>NEXTAUTH_SECRET</code>, or <code>NEXTAUTH_URL</code>.
          </p>
        </div>
      </div>
    );
